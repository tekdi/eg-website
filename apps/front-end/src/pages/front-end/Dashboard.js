    ...
    <Layout _appBar={{ profile_url: facilitator?.documents?.[0]?.name }}>
      <VStack space="5" bg="gray.200">
        <HStack
          ...
          {...styles.inforBox}
        >
          <IconByName isDisabled name="UserLineIcon" _icon={{ size: "25px" }} />
          <VStack>
            <Box>
        ...
        <Stack bg="bgPinkColor.300" space="6" p={4}>
          ...
          <Text fontSize="sm">
            You need to upload these documents before attending your Pragati
            orientation
          </Text>
          <HStack space="2">
            <IconByName
            ...
            <VStack>
              ...
              <Text fontSize="xs">
                (This can be your highest grade or graduation certificate)
              </Text>
            </VStack>
          </HStack>
          <HStack space="2">
            ...
            <VStack>
              ...
              <Text fontSize="xs">
                (This can be letter of recommendation from your
                company/workplace)
              </Text>
            </VStack>
          </HStack>
          <HStack space="2">
            ...
            <VStack>
              ...
              <Text fontSize="xs">
                (This can be references or letter of recommendation from the
                organization)
              </Text>
            </VStack>
          </HStack>
        ...
        <Stack space="5" p="5">
          ...
          <HStack space="2">
            ...
            <ButtonStyle shadow="RedFillShadow" width="50%">
              <Text fontSize="lg" bold color="white">
                {t("ACCEPT")}
              </Text>
            </ButtonStyle>
        ...
        <Stack bg="bgPinkColor.300" space="6" p={4}>
          ...
          <HStack>
            <IconByName
              ...
              _icon={{ size: "20px" }}
            />
            <Text fontSize="sm" space="1" pl="2">
              {t("DOCUMENTS_YOU_NEED_TO_CARRY")}
            </Text>
          </HStack>
          <Text fontSize="sm">
            Make sure you have the following list of documents with you when you
            attend the orientation.
          </Text>
          <View style={{ marginBottom: 10 }} space="3">
            <Text
              style={{ fontSize: 14 }}
            >{`\u2022 Original Aadhaar Card`}</Text>
            <Text
              style={{ fontSize: 14 }}
            >{`\u2022 Graduation Certificates`}</Text>
            <Text
              style={{ fontSize: 14 }}
            >{`\u2022 Work Experience Proof`}</Text>
            <Text
              style={{ fontSize: 14 }}
