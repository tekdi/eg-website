  ...
  return (
    ...
    <Box className="adharVerifyStart" w="full" minH="100vh">
      <Box className="content" p="4" flexGrow="1" w="full">
        ...
        <FrontEndTypo.H3 textAlign="center">{t("OFFLINE_KYC_MESSAGE")}</FrontEndTypo.H3>
        ...
        >
          ...
          <HStack alignItems="center">
            <IconByName name="ErrorWarningLineIcon" size="13px" mr="2"  color="red.600" />
          ...
          <FrontEndTypo.H1 textAlign="center" color="textGreyColor.500">OR</FrontEndTypo.H1>
          ...
          <FrontEndTypo.H3 textAlign="center">{t("COMPLETE_AADHAR_VERIFICATION_MESSAGE")}</FrontEndTypo.H3>
        <FrontEndTypo.Secondarybutton my="4"
          onPress={() => {
        ...
        <Text color="red.600" display="flex" alignItems="center" gap="1" mt="2">
