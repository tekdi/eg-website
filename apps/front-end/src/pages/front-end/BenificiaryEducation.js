...
export default function BenificiaryEducation() {
    ...
    <Layout _appBar={{ name: t("EDUCATION_DETAILS") }}>
      <VStack  bg="bgGreyColor.200">
        ...
        >
            ...
            <VStack px="5" py="4" mb="3" borderRadius="10px" borderWidth="1px" bg="white" borderColor="appliedColor">
 ...
 color="iconColor.100" />
            ...
            <VStack  px="5" py="4" mb="3" borderRadius="10px" borderWidth="1px" bg="white" borderColor="appliedColor">
              <HStack justifyContent="space-between" alignItems="Center" borderBottomWidth="1px" borderBottomColor="appliedColor">
                <FrontEndTypo.H3
                  bold
                  color="textGreyColor.800"
