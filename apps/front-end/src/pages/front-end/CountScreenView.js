...
export default function TableView() {
    ...
    return (
        <VStack space="15" paddingLeft="4%" paddingTop="10%" paddingRight="4%">
            <Container>
                <Box borderWidth={1} borderColor="gray.300" borderRadius={4} overflow="hidden">
                    <Box flexDirection="row" borderBottomWidth={1} borderBottomColor="gray.300" bg="gray.100" p={2}>
