...
export const getAcademicYear = async (params = {}, header = {}) => {
  try {
    ...
    const result = await post(
      `${process.env.REACT_APP_API_URL}/program-coordinator/get/academic-year-details`,
      params,
      {
        headers
      }
...
export const verifyEnrollmentPC = async (params = {}, header = {}) => {
  try {
    let headers = {
      Authorization: 'Bearer ' + localStorage.getItem('token'),
      ...header
    ...
    const result = await post(
      `${process.env.REACT_APP_API_URL}/program-coordinator/verify/enrollment`,
      params,
      {
        headers
      }
...
export const verifyMobilePC = async (params = {}, header = {}) => {
  try {
    let headers = {
      Authorization: 'Bearer ' + localStorage.getItem('token'),
      ...header
    ...
    const result = await post(
      `${process.env.REACT_APP_API_URL}/program-coordinator/mobile/validation`,
      params,
      {
        headers
      }
