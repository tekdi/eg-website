...
export const getDuplicateList = async (params = {}, header = {}) => {
  try {
    let headers = {
      ...header,
      Authorization: 'Bearer ' + localStorage.getItem('token')
...
export const getDetailsByadhaar = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/beneficiaries/admin/list/duplicates-by-aadhaar`,
      params,
      {
        headers: headers ? headers : {}
      }
...
export const assignToPrerak = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
