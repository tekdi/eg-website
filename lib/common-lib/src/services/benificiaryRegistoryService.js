...
export const getRequestDetails = async (params = {}, header = {}) => {
...
export const updateEditRequest = async (updateObj) => {
  try {
    ...
    const result = await patch(
      `${process.env.REACT_APP_API_URL}/edit-request/admin/update-edit-requests/${updateObj.id}`,
      updateObj,
      { headers }
    )
