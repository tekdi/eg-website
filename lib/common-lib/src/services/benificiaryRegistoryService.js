...
export const createEditRequest = async (params = {}, header = {}) => {
  try {
    ...
    if (result?.data) {
      console.log('create edit request', result)
      return result?.data
    } else {
      return {}
    }
...
export const getRequestDetails = async (id, data = {}, header = {}) => {
  try {
    let headers = {
      Authorization: 'Bearer ' + localStorage.getItem('token'),
      ...header
    ...
    const result = await patch(
      `${process.env.REACT_APP_API_URL}/edit-request/admin/update-edit-requests/${id}`,
      params,
      {
        headers: headers
      },
    ...
    if (result?.data) {
      console.log('update request', result?.data)
      return result?.data
    } else {
      return {}
    }
...
export const editFields = async (params = {}, header = {}) => {
  try {
    let headers = {
      ...header,
      Authorization: 'Bearer ' + localStorage.getItem('token')
    ...
    if (result?.data) {
      console.log('create edit request', result?.data)
      return result?.data
    } else {
      return {}
    }
