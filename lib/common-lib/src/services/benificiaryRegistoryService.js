...
export const isExistSSOID = async (params = {}, header = {}) => {
  try {
    let headers = {
      ...header,
      Authorization: 'Bearer ' + localStorage.getItem('token')
    ...
    const result = await post(
      `${process.env.REACT_APP_API_URL}/beneficiaries/ssoid-validation`,
      params,
      {
        headers: headers
      }
...
export const verifySYC = async (formData, header = {}) => {
  try {
    let headers = {
      ...header,
      Authorization: 'Bearer ' + localStorage.getItem('token')
    ...
    const result = await post(
      `${process.env.REACT_APP_API_URL}/beneficiaries/admin/verify-psyc`,
      formData,
      {
        headers: headers
      }
...
export const checkLearnerDetails = async (id, header = {}) => {
  try {
    let headers = {
      ...header,
      Authorization: 'Bearer ' + localStorage.getItem('token')
    ...
    const result = await get(
      process.env.REACT_APP_API_URL +
        '/beneficiaries/enrollment-validation/' +
        id,
      {
        headers
      }
...
export const updateDisability = async ({ id, ...props } = {}, header = {}) => {
  try {
    let headers = {
      Authorization: 'Bearer ' + localStorage.getItem('token'),
      ...header
    ...
    const result = await patch(
      `${process.env.REACT_APP_API_URL}/beneficiaries/disability/${id}`,
      props,
      {
        headers
      }
...
export const checkIsEnrollmentAvailable = async (
  { id, ...props } = {},
  header = {}
) => {
  try {
    ...
    const result = await get(
      `${process.env.REACT_APP_API_URL}/beneficiaries/is_enrollment_available/${id}`,
