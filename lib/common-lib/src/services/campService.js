...
export const getCampKitDetails = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/program-coordinator/camps/${params?.camp_id}`,
      params,
      {
        headers: headers || {}
      }
...
export const getCampLeaners = async ({ id, ...params } = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/camp/${id}/camp_learners`,
      params,
      {
        headers: headers || {}
      }
...
export const multipleReassign = async ({ id, ...params } = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await patch(
      `${process.env.REACT_APP_API_URL}/camp/admin/multiplereassign/${id}`,
      params,
      {
        headers: headers || {}
      }
...
export const getCampDetailsCount = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/camp/campday/campDetails`,
      params,
      {
        headers: headers || {}
      }
...
export const closePcrCamp = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/camp/admin/end_pcr`,
      params,
      {
        headers: headers || {}
      }
...
export const multipleClosePcr = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/camp/admin/multiple_end_pcr`,
      params,
      {
        headers: headers || {}
      }
...
// pc user
export const getPrerakCampList = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    Authorization: 'Bearer ' + localStorage.getItem('token')
  }
  ...
  try {
    const result = await post(
      ...
      { withCampFilter: 'campFilter', ...params },
      {
        headers
      }
    )
...
export const getCampPrerak = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    Authorization: 'Bearer ' + localStorage.getItem('token')
  }
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/program-coordinator/camps/list`,
      params,
      {
        headers
      }
...
export const getPrerakCampProfile = async (id, params = {}, header = {}) => {
  let headers = {
    ...header,
    Authorization: 'Bearer ' + localStorage.getItem('token')
  }
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/program-coordinator/camps/${id}`,
      params,
      {
        headers
      }
...
export const getSubjectsList = async (params = {}, header = {}) => {
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/pcrscores/subjects/list`,
      params,
      {
        headers: headers || {}
      }
...
export const getStudentsList = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/pcrscores/subjects/learners`,
      params,
      {
        headers: headers || {}
      }
...
export const updateAssessmentScore = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/pcrscores/create/formative-assessment`,
      params,
      {
        headers: headers || {}
      }
...
export const getCampLearnerScores = async (params = {}, header = {}) => {
  let headers = {
    ...header,
    'Content-Type': 'application/json',
    Authorization: 'Bearer ' + localStorage.getItem('token')
  ...
  try {
    const result = await post(
      `${process.env.REACT_APP_API_URL}/camp/camp_learner_list/check_baseline`,
      params,
      {
        headers: headers || {}
      }
