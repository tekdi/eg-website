...
import VidiconLine from 'remixicon-react/VidiconLineIcon'
...
export default function IconByName({ _icon, ...props }) {
  ...
  switch (props.name) {
    case 'GraduationCap':
      icon = <IconButton {...props} icon={<GraduationCap {...(_icon ? _icon : {})} />} />
      break
      case 'Male':
      icon = <IconButton {...props} icon={<Male {...(_icon ? _icon : {})} />} />
      break
    case 'Female':
      icon = (
        <IconButton {...props} icon={<Female {...(_icon ? _icon : {})} />} />
      )
      break
    case 'Other':
      icon = (
        <IconButton {...props} icon={<Other {...(_icon ? _icon : {})} />} />
      )
      break
    case 'Chat3LineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<Chat3LineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'DeleteBinLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<DeleteBinLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'MenuLineIcon':
    ...
    case 'Chat4LineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<Chat4LineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'PhoneLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<PhoneLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'SuitcaseLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<SuitcaseLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'AttachmentLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<AttachmentLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'AndroidLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<AndroidLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'AppleLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<AppleLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'Upload2FillIcon':
      icon = (
        <IconButton
          {...props}
          icon={<Upload2FillIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'ArrowDownSFillIcon':
      icon = (
        <IconButton
          {...props}
          icon={<ArrowDownSFillIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'FlashlightFillIcon':
      icon = (
        <IconButton
          {...props}
          icon={<FlashlightFillIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'FilterLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<FilterLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'TimeLineIcon':
    ...
    case 'CellphoneLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<CellphoneLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'CustomerService2LineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<CustomerService2LineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'GroupLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<GroupLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'DonutChartLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<DonutChartLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'MessageLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<MessageLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'ShutDownLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<ShutDownLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'LoginCircleLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<LoginCircleLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'PencilRulerLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<PencilRulerLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'CommunityLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<CommunityLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'VidiconLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<VidiconLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'UserAddLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<UserAddLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'CalendarLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<CalendarLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'ErrorWarningLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<ErrorWarningLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'SendPlaneFillIcon':
      icon = (
        <IconButton
          {...props}
          icon={<SendPlaneFillIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'Cake2LineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<Cake2LineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'SmartphoneLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<SmartphoneLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'MailLineIcon':
    ...
    case 'HistoryLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<HistoryLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'Forbid2LineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<Forbid2LineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    ...
    case 'LockUnlockLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<LockUnlockLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    case 'HeartLineIcon':
      icon = (
        <IconButton
          {...props}
          icon={<HeartLineIcon {...(_icon ? _icon : {})} />}
        />
      )
      break
    default:
