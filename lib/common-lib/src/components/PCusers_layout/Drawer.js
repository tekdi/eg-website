      ...
      <Stack space={4}>
        <VStack space={4}>
          ...
          <VStack alignItems='Center' display='flex'>
            ...
            <ChipStatus status={facilitator ? prerak_status : 'under_review'} />
            ...
            >
              <HStack justifyContent='space-between' alignItems='center'>
                <HStack alignItems='Center' space='sm'>
                  ...
                  <FrontEndTypo.H2 ml='19px'>{t('RESULTS')}</FrontEndTypo.H2>
                </HStack>
                <ChevronRightIcon size='sm' />
              </HStack>
            </Pressable>
        ...
        <FrontEndTypo.H3 textAlign='center'>V2.2.0</FrontEndTypo.H3>
      </Stack>
    </Drawer>
  )
}
