      ...
      if (item.value > 0) {
        return (
          <Box
            ...
            {..._labelCount}
          >
            {item.value.toString().padStart(2, '0') + (sufix || '')}
          </Box>
        )
      }
      return undefined
...
ProgressBar.propTypes = {
  ...
  isTextShow: PropTypes.bool,
  isTextInBar: PropTypes.bool,
  isLabelCountHide: PropTypes.bool,
  _bar: PropTypes.object,
  _labelCount: PropTypes.object,
  _textInBar: PropTypes.object,
