...
//getting aaray 
//if enumtypedata?.length>0 then 
//find the value where enumOtpion
//check if !traslation?.title 
//then return transaction?.title
//else return value
//translateEnumOption("PREVIOUS_SCHOOL_TYPE",benificiary?.core_beneficiaries?.previous_school_type,data?.data)
//create a function to return translated value
