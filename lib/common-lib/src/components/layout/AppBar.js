...
export default function AppBar({
  ...
  const handleInstallPWA = () => {
    ...
    } else if (localStorage.getItem('appInstall') === 'yes') {
      let opentButton = null
      try {
        opentButton = document.getElementById('pwalink')
        opentButton.href = window.location.href
    ...
    >
      <HStack justifyContent='space-between'>
        ...
        <HStack justifyContent={'flex-end'} space='2' pt='2' pr='2'>
          ...
          {(localStorage.getItem('pwa') === 'yes' ||
            localStorage.getItem('appInstall') === 'yes') && (
            <Box>
              <Button
                py='1'
                px='2'
