...
const menus = [
  ...
  { title: 'PC_LIST', icon: 'TeamFillIcon', route: '/admin/pc' }
  // Temp Comment End
...
export default function Layout({
  ...
  if (loading === true) {
    return <Loading windowWidth='100%' cWidth={width} />
  }
...
Layout.propTypes = {
  ...
  getRefAppBar: PropTypes.func,
  _appBar: PropTypes.object,
  _header: PropTypes.object,
  _sidebar: PropTypes.object,
