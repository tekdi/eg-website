            ...
            <HStack justifyContent='end' alignItems='center'>
              {filters.map((value, index) => {
                ...
                const overrideBtnProp = isSelect
                  ? { ..._button, bg: 'primary.500' }
                  : _button
                const overrideOptionBtnProp = isSelect
                  ? { ..._optionButton, bg: 'primary.500' }
                  : _optionButton
                return (
                  <Button
                    key={index}
                    ...
                    rightIcon={
                      <IconByName
                        color={isSelect ? 'white' : 'primary.500'}
                  ...
                  >
                    <Text color={isSelect ? 'white' : 'primary.500'}>
                      {isSelect ? '' : value.name}
                      {isSelect ? (
                        <Tooltip
                  ...
                  <HStack space='2' colorScheme='button' alignItems='center'>
                    {type === 'array' ? (
                      <IconByName
                        isDisabled
                        color={
                          valueArr.includes(value) ? 'primary.500' : 'gray.300'
                        }
                        name={
